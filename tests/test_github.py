...
def test_get_instance():
    ...
    g = pyreleaser_io.vcs.github.get_instance(gh_settings)
    project = tests.test_globals.project

    # user info population
    pyreleaser_io.vcs.github.add_user_info(project, g)
    assert project.get("author")
    # doesn't work?
    # assert project.get("author_email")

    # URL generation
    assert pyreleaser_io.vcs.github.project_url(project, g) == "https://github.com/GeoffWilliams/test_proj.git"
